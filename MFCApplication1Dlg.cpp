...
BEGIN_MESSAGE_MAP(CMFCApplication1Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BTN_Image, &CMFCApplication1Dlg::OnBnClickedBtnImage)
...
void CMFCApplication1Dlg::OnBnClickedBtnImage()
{
	int nWidth = 320;
	int nHeight = 240;
	int nBpp = 8;
...
bool CMFCApplication1Dlg::inInCircle(int i, int j, int nCenterX, int nCenterY, int nRadius) {
	bool bRet = false;
